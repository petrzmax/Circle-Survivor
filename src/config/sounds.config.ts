...
export const SOUND_DEFINITIONS: Record<string, SoundDefinition> = {
  ...
  gameOver: {
    steps: [
      ...
      { type: 'tone', frequency: 300, duration: 0.2, oscillator: 'sawtooth', volume: 0.4, delay: 150 },
      { type: 'tone', frequency: 200, duration: 0.3, oscillator: 'sawtooth', volume: 0.4, delay: 300 },
      { type: 'tone', frequency: 100, duration: 0.5, oscillator: 'sawtooth', volume: 0.5, delay: 450 },
    ],
  },
  ...
  countdownTick_0: {
    steps: [
      ...
      { type: 'tone', frequency: 600, duration: 0.1, oscillator: 'triangle', volume: 0.35, delay: 100 },
    ],
  },
};
